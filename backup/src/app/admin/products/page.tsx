                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                        ...
                        <div className="bg-neutral-50 p-3 rounded-lg border border-neutral-200">
                          <p className="text-xs text-neutral-700 mb-1 font-medium">Duration</p>
                          <p className="text-sm font-bold text-neutral-900">{product.duration} month(s)</p>
                        </div>
                      </div>
            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditingProduct({ ...editingProduct, duration: parseInt(e.target.value) })
                  }
                  className="text-lg font-semibold"
                />
                <p className="text-xs text-neutral-500 mt-1">How many months customers can purchase</p>
              </div>
